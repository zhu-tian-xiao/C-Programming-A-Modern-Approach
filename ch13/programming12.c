...
int read_sentence(char (*sentence)[WORD_LEN + 1]);
void print_sentence(char (*sentence)[WORD_LEN + 1], int lastLocation);
void print_reverse_sentence(char (*sentence)[WORD_LEN + 1], int lastLocation);
int main() {
...
void print_reverse_sentence(char (*sentence)[WORD_LEN + 1], int last_location) {
