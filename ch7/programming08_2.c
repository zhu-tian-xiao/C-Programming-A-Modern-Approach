// FINISH
// https://github.com/williamgherman/c-solutions/tree/master/07/projects
// 关于这道题是忽略了12时的情况
#include <ctype.h>
#include <stdio.h>

int main(void) {
  int user_time, hour, minute, d1 = 480, d2 = 583, d3 = 679, d4 = 767, d5 = 840,
                               d6 = 945, d7 = 1140, d8 = 1305;
  ...
  if (hour == 12) {
		if (toupper(c) == 'P') {
			user_time = 12 * 60 + minute;
		} else {
			user_time = 0 * 60 + minute;
		}
	}
